...
const scookie = document.getElementById("scookie");
const jcookie = document.getElementById("jcookie");
const canBuyCharges = document.getElementById("canBuyCharges");
...
form.addEventListener('submit', async (e) => {
    ...
    try {
        const response = await axios.post('/init', {
            ...
            cookies: { s: scookie.value, j: jcookie.value },
